...
//        DriverManagerDataSource dataSource = new DriverManagerDataSource(URL, USERNAME, PASSWORD); // dataSource 세팅
        ...
        repository = new MemberRepositoryV1(dataSource); // V1 생성자 파라미터 dataSource 주입
